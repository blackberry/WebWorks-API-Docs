...
blackberry.utils = {
	...
	/**
	 * @desc Construct a new String by converting the blob using the specified character encoding
	...
	/**
	 * @desc Convert a document into a Blob. Supported in 5.0.0 only. 
	...
	/**
	 * @desc Convert a string object into a Blob using the specified character encoding.
	...
	/**
	 * @desc This method will generate a unique number.
	...
	/**
	 * @desc Parses a URL string and returns an URL object.
	 ...
	 * @toc {Utilities} URL
	 * @featureID blackberry.utils
	 * @desc I CONSTRUCT YOU
	 */
	URL : {
		
		
		/**
		 * @desc Obtain the value of a parameter by key.
		...
		/**
		 * @desc Obtain the value of a parameter by index. The values are stored in the order they appear in the URL string.
		 ...
		 * @type String
		 * @PB10
		 * @desc Host address in the URL string.
		 */
		host:null,
		/**
		 * @readOnly
		 * @type String
		 * @PB10
		 * @desc Port number in the URL string.
		 */
		port:null
	}
};
...
*   &sol;&sol; Check if in active call
*   var res = blackberry.phone.Phone.inActiveCall();
*   alert(&quot;Currently in active call? &quot; + res);
* &lt;&sol;script&gt;
* @example
* &lt;script type=&quot;text&sol;javascript&quot;&gt;
*   &sol;&sol; Retrieve an array of active calls and display the details of the call at index specified
...
* @example
* &lt;script type=&quot;text&sol;javascript&quot;&gt;
*   &sol;&sol; Adding three listeners differ by their type.
...
* 
*   &sol;&sol; Removing one of the previously added listeners
...
* @returns {blackberry.phone.Phone.Call[]}
* @BB50+
*/
...
* @param {OnPhoneEvent} callback This ScriptableFunction invoked when appropriate phone call event occured.
* @param {Number} [eventType] One of constants defining phone call event type.
* @returns {Boolean}
* @BB50+
*/
blackberry.phone.Phone.addPhoneListener = function(callback,eventType) { };
...
*         </p></div>
* @toc {Phone} Phone OnPhoneEvent 
* @BB50+
* @class Interface to provide information for the phone events.
* @constructor 
* @param {Number} callId ID for the resumed call.
* @param {Number} [reason] CALL_ERROR_* code describing the reason for the failure when callback for CB_CALL_FAILED is triggered
*/
blackberry.phone.Phone.OnPhoneEvent = function(callId,reason) { };

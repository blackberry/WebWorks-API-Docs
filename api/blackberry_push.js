...
blackberry.push = { 
    ...
    *     var  dbgDiv = document.getElementById("txtAreaPushData");
	*     try {
	*       dbgDiv.innerHTML +="&lt;br&gt;"+blackberry.utils.blobToString(data.payload);
    *       return 0;
    *     } 
	*     catch (err) {
    *       alert(err);
    ...
    *     var  dbgDiv = document.getElementById("txtAreaPushData");
    *     dbgDiv.innerHTML +="&lt;br&gt;"+"SIM card is changed!";
    *   }
	* &lt;/script&gt;
	*/

...
canvas ={
		...
		/**
		 * @descripton Specifies the height of the canvas.
		 * <p/>
		...
		/**
		 * @descripton Specifies the width of the canvas.
		 * <p/>
		...
		/**
		 * @descripton Returns an object that exposes an API for drawing on the canvas. 
		...
		/**
		 * @descripton Returns a data:URL for the image in the canvas.

...
localStorage ={
		...
		/**
		 * @PB10
		 * @description cause the key/value pair with the given key to be removed from the list associated with the object, if it exists. If no item with that key exists, the method do nothing.
		 * @param  {String} key the key for the key/value pair
		 * @example
		...
		/**
		 * @PB10
		 * @description atomically cause the list associated with the object to be emptied of all key/value pairs, if there are any. If there are none, then the method do nothing.
		 */
		clear : function(){}
};